...
# “0：%H”0表示数字对齐格线，
# %H表示标签以小时显示
rrdtool.graph( "Flow.png", "--start", str(sys.argv[1]),"--end",str(sys.argv[2]), "--vertical-label=MB/s","--x-grid","MINUTE:12:HOUR:1:HOUR:1:0:%H:%M",\
"--width","650","--height","230","--title",title,
"DEF:inoctets=Flow2.rrd:enp0s3_in:AVERAGE",         #指定网卡入流量数据源DS及CF
"DEF:outoctets=Flow2.rrd:enp0s3_out:AVERAGE",       #指定网卡出流量数据源DS及CF
